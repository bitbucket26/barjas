...
<div class="modal fade" id="modalcetak<?php echo $d['id']; ?>" role="dialog">
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    ?>
                                                        ...
                                                        <a class="dropdown-item" href="sortirbaphp.php?id=<?php echo $d['id']; ?>" target="_blank">3.  BAPHP</a>
                                                        <a class="dropdown-item" href="cetak/bastb.php?id=<?php echo $d['id']; ?>" target="_blank">4.  BASTB</a>
                                                        <a class="dropdown-item" href="cetak/ppembayaran.php?id=<?php echo $d['id']; ?>" target="_blank">5.  Permohonan Pembayaran</a>
                                                        <a class="dropdown-item" href="cetak/bap.php?id=<?php echo $d['id']; ?>" target="_blank">6.  BAP (3 rangkap, Materai silang)</a>
                                                        <a class="dropdown-item" href="cetak/sptjm.php?id=<?php echo $d['id']; ?>" target="_blank">7.  SPTJM</a>
