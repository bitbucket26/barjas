...
<section class="sheet padding-10mm" style="font-size:18px;">
    <div class="container-xxl">
        ...
        <div class="row">
                ...
                <h4><b>RINGKASAN DOKUMEN KONTRAK</b></h4>
                </div>
        </div>
        <br>
        <div class="row">
        ...
        <div class="row">
                ...
                <div class="col-7">
                : <?php echo $row['nomordpa']; ?> <br>tanggal <?php echo tglindo($row['tgldpa']); ?>
                </div>
        </div>
        <div class="row">
                <div class="col-1 text-end">
        ...
        <div class="row">
                ...
                <div class="col-7">
                : <?php echo $row['nomorkontrak']; ?> <?php echo tglindo($row['tglmulaikontrak']); ?>
                </div>
        </div>
        <div class="row">
                <div class="col-1 text-end">
        ...
        <div class="row">
                ...
                <div class="col-7">
                : Bank <?php echo $row['namabank']; ?> No.Rek <?php echo $row['norekening']; ?>
                </div>
        </div>
        <div class="row">
                <div class="col-1 text-end">
        ...
        <div class="row">
                ...
                <div class="col-7">
                : Sekaligus Rp. <?php echo number_format($row['nilaitotalnego']); ?>,-
                </div>
        </div>
        <div class="row">
                <div class="col-1 text-end">
