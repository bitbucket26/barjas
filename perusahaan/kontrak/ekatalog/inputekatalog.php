                                                ...
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-floating">
                                                            ...
                                                            <input style="height: 30px; font-size: 13px;" value="1" type="text" name="nopenawaran" class="form-control" id="nopenawaran" hidden>
                                        ...
                                        <div class="row g-2">
                                                        <div class="col-4">
                                                            <div class="form-floating">
                                                                ...
                                                                <input style="font-size: 13px;" value="1" type="number" name="nilainego" class="form-control" id="nilainego" hidden>                                       
                                                            </div>
                                                        </div>
                                                        <div class="col-8">
                                                            <div class="form-floating">
                                                                <!-- <label class="labeldata">Terbilang</label> -->
                                                                <input style="font-size: 13px;" value="1" type="text" name="terbilangnego"  class="form-control" id="terbilangnego" hidden>                                            
                                                            </div>
                                                        </div>
                                                </div>
                                                <div class="row g-2">
                                                    <div class="col-4">
                                                        <div class="form-floating">
                                                            ...
                                                            <!-- <input style="height: 30px; font-size: 13px;" type="float" name="nilaihps"  class="form-control" id="input style="height: 30px; font-size: 13px;"kua" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" hidden> -->
                                                            <input style="height: 30px; font-size: 13px;" type="number" name="nilaitotalnego" class="form-control" id="nilaitotalnego" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                        <div class="form-floating">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <h4>PEJABAT PEMERIKSA HASIL PEKERJAAN</h4>
