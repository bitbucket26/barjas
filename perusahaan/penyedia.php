        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!--<div class="">-->
                    <!--<button type="button" data-toggle="modal" class="btn btn-info btn-md" data-target="#myModaltambah" style="border-radius: 30px;">-->
                ...
                <div class="card shadow mb-4" style="border-radius: 30px;">
                        <div class="card-header py-3" style="border-radius: 30px;">
                            <h6 class="m-0 font-weight-bold text-primary">Data Penyedia / Vendor</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0" style="border-radius: 15px; font-size: 12px;">
                                    ...
                                    <!-- <tbody style="font-size: 14px;"> -->
                                        ...
                                        <td class="text-center align-middle"><?php echo $d['id']; ?></td>
                                            ...
                                            <td class="align-middle"><?php echo $d['namapimpinan']; ?></td>
                                    ...
                                    ?>
                                    <?php
                                        // include "modaltambahpenyedia.php";
                                    ?>
