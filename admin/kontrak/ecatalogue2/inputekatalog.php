                    ...
                    <!-- Input Data -->
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Input Kontrak (E-Catalogue)</h6>
                            </div>



                            <form action="simpanekatalog.php" method="POST">
                            <?php 
                                include "maxid.php";
                            ?>
                                <!-- Kolom 1 -->
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-6">
                                                        <div class="form-floating">
                                                            ...
                                                            <input style="height: 30px; font-size: 13px;" type="text" name="jeniskontrak" value="E-Catalogue" class="form-control" id="jeniskontrak" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-floating">
                                                            <label class="labeldata">*</label>
                                                            <input style="height: 30px; font-size: 13px;" type="text" name="bilangjeniskontrak" value="Surat Pesanan" class="form-control" id="bilangjeniskontrak" readonly>                                               
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row g-2">
...
<div class="row g-2">
                                ...
                                <!-- Footer -->
                                            <div class="modal-footer">  
                                                ...
                                                <a href="ecatalogue2.php" type="button" class="btn btn-default">Batal</a>
