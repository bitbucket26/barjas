...
<table style="width:100%;">
		...
		<tbody>
            ...
            <tr>
				...
				<td class="col-1">Ytd.</td>
				<td rowspan="3" style="vertical-align: text-top; text-align: justify;">Pejabat Pemeriksa Hasil Pekerjaan<?php echo $row['pekerjaan']; ?><?php echo $row['kegiatan']; ?></td>
			</tr>
			<tr>
