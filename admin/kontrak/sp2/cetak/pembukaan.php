...
<section class="sheet padding-10mm" style="font-size:17px;">
    <div class="container-xxl">
        ...
        <div class="d-flex justify-content-center">
            ...
            <br>
        <!-- Judul Nota -->
         <h4 class="text-center">BERITA CARA PEMBUKAAN PENAWARAN</h4>
        <div class="d-flex justify-content-center">
        ...
        pada tanggal <?php echo $row['tglskpejabatbarjas'];?> Nomor <?php echo $row['nomorskpejabatbarjas'];?> melaksanakan pembukaan Penawaran untuk pelaksanaan 
