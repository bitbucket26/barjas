...
<?php
	...
	function terbilang($nilai) {
        ...
        $tglbastb= $row['tglpenetapanpenyedia'];
...
<section class="sheet padding-10mm" style="font-size:17px;">
    <div class="container-xxl">
        ...
        <div class="d-flex justify-content-center">
            ...
            <br>
        <!-- Judul Nota -->
         <h4 class="text-center">BERITA CARA PENETAPAN PEMENANG</h4>
        ...
        <div class="row">
            ...
            <div class="col-8">
            : <?php echo number_format($row['nilainego']);?>
            </div>
        </div>
        <div class="row">
            <div class="col-4">
        ...
        <br>
        <div class="row" style="text-align: justify;">
        Demikian Barita Penetapan Pemenang Pengadaan Langsung ini dibuat setelah melewati proses pengadaan sesuai dengan Dokumen pengadaan, dan di tanda tangai oleh Pejabat Pengadaan untuk dipergunakan sebagaimana mestinya.													
        </div>
        <br>
