                                                ...
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="form-floating">
                                                            ...
                                                            <input style="height: 30px; font-size: 13px;" type="text" name="bilangjeniskontrak" value="Surat Perjanjian" class="form-control" id="bilangjeniskontrak" readonly>                                               
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row g-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row g-2">
                                                    ...
                                                    <div class="col-6">
                                                                <div class="form-floating">
                                                                    <label class="labeldata">NIP</label>
                                                                    <input style="height: 30px; font-size: 13px;" type="text" name="nippemeriksa1" class="form-control" id="nippejabatpemeriksa" readonly>                                               
                                                                </div>
                                                    </div>
                                                </div>
                                                <div class="row g-2">
                                                    <div class="col-6">
                                                                <div class="form-floating">
                                                                    <label class="labeldata">Nomor SK</label>
                                                                    <input style="height: 30px; font-size: 13px;" type="text" name="nomorskpemeriksa1" class="form-control" id="nomorskpejabatpemeriksa" readonly>                                               
                                                                </div>
                                                    </div>
                                                    <div class="col-6">
                                                                <div class="form-floating">
                                                                    <label class="labeldata">Tanggal SK</label>
                                                                    <input style="height: 30px; font-size: 13px;" type="date" name="tglskpemeriksa1" class="form-control" id="tglskpejabatpemeriksa" readonly>                                               
                                                                </div>
                                                    </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="row g-2">
                                                    ...
                                                    <div class="col-6">
                                                                <div class="form-floating">
                                                                    <label class="labeldata">NIP</label>
                                                                    <input style="height: 30px; font-size: 13px;" type="text" name="nippemeriksa2" class="form-control" id="nippejabatpemeriksa2" readonly>                                               
                                                                </div>
                                                    </div>
                                                </div>
                                                <div class="row g-2">
                                                    <div class="col-6">
                                                                <div class="form-floating">
                                                                    <label class="labeldata">Nomor SK</label>
                                                                    <input style="height: 30px; font-size: 13px;" type="text" name="nomorskpemeriksa2" class="form-control" id="nomorskpejabatpemeriksa2" readonly>                                               
                                                                </div>
                                                    </div>
                                                    <div class="col-6">
                                                                <div class="form-floating">
                                                                    <label class="labeldata">Tanggal SK</label>
                                                                    <input style="height: 30px; font-size: 13px;" type="date" name="tglskpemeriksa2" class="form-control" id="tglskpejabatpemeriksa2" readonly>                                               
                                                                </div>
                                                    </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="row g-2">
                                                    ...
                                                    <div class="col-6">
                                                                <div class="form-floating">
                                                                    <label class="labeldata">NIP</label>
                                                                    <input style="height: 30px; font-size: 13px;" type="text" name="nip3pemeriksa3" class="form-control" id="nippejabatpemeriksa3" readonly>                                               
                                                                </div>
                                                    </div>
                                                </div>
                                                <div class="row g-2">
                                                    <div class="col-6">
                                                                <div class="form-floating">
                                                                    <label class="labeldata">Nomor SK</label>
                                                                    <input style="height: 30px; font-size: 13px;" type="text" name="nomorskpemeriksa3" class="form-control" id="nomorskpejabatpemeriksa3" readonly>                                               
                                                                </div>
                                                    </div>
                                                    <div class="col-6">
                                                                <div class="form-floating">
                                                                    <label class="labeldata">Tanggal SK</label>
                                                                    <input style="height: 30px; font-size: 13px;" type="date" name="tglskpemeriksa3" class="form-control" id="tglskpejabatpemeriksa3" readonly>                                               
                                                                </div>
                                                    </div>
                                                </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                                ...
                                                <input style="height: 30px; font-size: 13px;" type="text" name="pemeriksa1" class="form-control" value="ARDI LASMANA, Amd.Farm" hidden>
                                                 <input style="height: 30px; font-size: 13px;" type="text" name="nippemeriksa1" class="form-control" value="19781010 200604 1 012" hidden>
                                                 <input style="height: 30px; font-size: 13px;" type="text" name="jabatanpemeriksa1" class="form-control" value="Ketua Panitia  Pemeriksa Hasil Pekerjaan Obat, Sterilisasi, BAHP Medis di RSUD Indramayu" hidden>
                                                 <input style="height: 30px; font-size: 13px;" type="text" name="pemeriksa2" class="form-control" value="TEUKU DIAN ANDIKA,ST" hidden>
                                                 <input style="height: 30px; font-size: 13px;" type="text" name="nippemeriksa2" class="form-control" value="19781005 200604 1 012" hidden>
                                                 <input style="height: 30px; font-size: 13px;" type="text" name="jabatanpemeriksa2" class="form-control" value="Anggota Panitia  Pemeriksa  Hasil Pekerjaan Obat, Sterilisasi, BAHP Medis di RSUD Indramayu" hidden>
                                                 <input style="height: 30px; font-size: 13px;" type="text" name="pemeriksa3" class="form-control" value="AYU RATNA HAYATI, S.Fram.Apt" hidden>
                                                 <input style="height: 30px; font-size: 13px;" type="text" name="nippemeriksa3" class="form-control" value="19870128 200604 2 002" hidden>
                                                 <input style="height: 30px; font-size: 13px;" type="text" name="jabatanpemeriksa3" class="form-control" value="Anggota Panitia  Pemeriksa  Hasil Pekerjaan Obat, Sterilisasi, BAHP Medis di RSUD Indramayu" hidden>
