...
<br>
        ...
        <div class="row">
                ...
                <div class="col-10 fw-bold" style="text-align: justify;">
                : <?php echo $row['namapejabatpemeriksa1']; ?>
                </div>
        </div>
        <div class="row">
                <div class="col-1">
                ...
                : <?php echo $row['nippejabatpemeriksa1']; ?>
                </div>
        </div>
        <div class="row">
                <div class="col-1">
        ...
        <div class="row">
                ...
                <div class="col-10 fw-bold" style="text-align: justify;">
                : <?php echo $row['namapejabatpemeriksa2']; ?>
                </div>
        </div>
        <div class="row">
                <div class="col-1">
                ...
                <div class="col-10" style="text-align: justify;">
                : <?php echo $row['nippejabatpemeriksa2']; ?>
                </div>
        </div>
        <div class="row">
                <div class="col-1">
        ...
        <div class="row">
                ...
                <div class="col-10 fw-bold" style="text-align: justify;">
                : <?php echo $row['namapejabatpemeriksa3']; ?>
                </div>
        </div>
        <div class="row">
                <div class="col-1">
                ...
                <div class="col-10" style="text-align: justify;">
                : <?php echo $row['nippejabatpemeriksa3']; ?>
                </div>
        </div>
        <div class="row">
                <div class="col-1">
        ...
        <div class="row">
                ...
                Nomor : <?php echo $row['nomorskpejabatpemeriksa1']; ?> 
                Tanggal <?php echo tglindo($row['tglskpejabatpemeriksa1']); ?> Telah Bersama-sama melakukan pemeriksaan/ penilaian pekerjaan terhadap :
                </div>        
        </div>
        <div class="row" style="text-align: justify;">
...
<br>
        ...
        <br>
                ...
                <div class="row text-center">
                    ...
                    <b>              
                    <?php echo $row['namapejabatpemeriksa1']; ?></b>
                    </div>
                    <div class="col-2"></div>
                </div>
                <div class="row text-center">
                    ...
                    <div class="col-1"></div>
                    <div class="col-4 text-start">             
                    NIP. <?php echo $row['nippejabatpemeriksa1']; ?>
                    </div>
                    <div class="col-2">..................................</div>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-4 text-start">             
                    <b><?php echo $row['namapejabatpemeriksa2']; ?></b>
                    </div>
                    <div class="col-2"></div>
                </div>
                <div class="row text-center">
                    ...
                    <div class="col-1"></div>
                    <div class="col-4 text-start">             
                    NIP. <?php echo $row['nippejabatpemeriksa2']; ?></u></b>
                    </div>
                    <div class="col-2">..................................</div>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-4 text-start">             
                    <b><?php echo $row['namapejabatpemeriksa3']; ?></b>
                    </div>
                    <div class="col-2"></div>
                </div>
                <div class="row text-center">
                    ...
                    <div class="col-1"></div>
                    <div class="col-4 text-start">             
                    NIP. <?php echo $row['nippejabatpemeriksa3']; ?></u></b>
                    </div>
                    <div class="col-2">..................................</div>
