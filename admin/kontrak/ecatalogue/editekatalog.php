                                                ...
                                                <div class="row g-2">
                                                    <div class="col-4">
                                                        <div class="form-floating">
                                                            ...
                                                            <input style="height: 30px; font-size: 13px;" value="<?php echo $row['jeniskontrak']; ?>" type="text" name="jeniskontrak" value="SP E-Catalogue" class="form-control" id="jeniskontrak" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                        <div class="form-floating">
...
<h4>NILAI KONTRAK >300 JUTA</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                                <div class="row g-2">
                                                    <div class="col-7">
                                                        <div class="form-floating">
                                                            <label hidden>HPS</label>
                                                            <input style="height: 30px; font-size: 13px;" value="-" type="text" name="hps" class="form-control" id="hps" hidden>
                                                             
                                                        </div>
                                                    </div>
                                                    <div class="col-5">
                                                        <div class="form-floating">
                                                            <label class="labeldata" hidden>*</label>
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-7">
                                                        <div class="form-floating">
                                                            <label hidden>Undangan Pejabat Barjas</label>
                                                            <input style="height: 30px; font-size: 13px;" value="-" type="text" name="undanganpejabatbarjas" class="form-control" id="undanganpejabatbarjas" hidden>
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-7">
                                                        <div class="form-floating">
                                                            <label hidden>Pembukaan</label>
                                                            <input style="height: 30px; font-size: 13px;" value="-" type="text" name="pembukaan" class="form-control" id="pembukaan" hidden>
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-7">
                                                        <div class="form-floating">
                                                            <label hidden>BA. Evaluasi Penawaran</label>
                                                            <input style="height: 30px; font-size: 13px;" value="-" type="text" name="baevaluasi" class="form-control" id="baevaluasi" hidden>
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-7">
                                                        <div class="form-floating">
                                                            <label hidden>Lam.BA.Evaluasi Penawaran</label>
                                                            <input style="height: 30px; font-size: 13px;" value="-" type="text" name="lambaevaluasi" class="form-control" id="lambaevaluasi" hidden>
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-7">
                                                        <div class="form-floating">
                                                            <label hidden>BA.Klar. Teknis Dan Negosiasi</label>
                                                            <input style="height: 30px; font-size: 13px;" value="-" type="text" name="baklarifikasi" class="form-control" id="baklarifikasi" hidden>
                                                        </div>
                                                    </div>
                                                    <div class="col-5">
                                                        <div class="form-floating">
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-7">
                                                        <div class="form-floating">
                                                        <label hidden>Lam.BA.Klar.Teknis Dan Negosiasi</label>
                                                        <input style="height: 30px; font-size: 13px;" value="-" type="text" name="lambaklarifikasi" class="form-control" id="lambaklarifikasi" hidden>
                                                        </div>
                                                    </div>
                                                    <div class="col-5">
                                                        <div class="form-floating">
                                        ...
                                        <div class="col-sm-4">
                                                <div class="row g-2">
                                                    <div class="col-7">
                                                        <div class="form-floating">
                                                            <label class="labeldata" hidden>BA.Hasil Pengadaan Langsung</label>
                                                            <input style="height: 30px; font-size: 13px;" value="-" type="text" name="bahasildasung" class="form-control" id="bahasildasung" hidden>
                                                    ...
                                                    <div class="col-5">
                                                        <div class="form-floating">
                                                            <label class="labeldata" hidden>*</label>
                                                            <input style="height: 30px; font-size: 13px;" value="2000-02-02" type="date" name="tglbahasildasung" class="form-control border-left-warning shadow" id="tglbahasildasung" hidden>                                               
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-7">
                                                        <div class="form-floating">
                                                            <label class="labeldata" hidden>Penetapan Penyedia</label>
                                                            <input style="height: 30px; font-size: 13px;" value="-" type="text" name="penetapanpenyedia" class="form-control" id="penetapanpenyedia" hidden>
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-7">
                                                        <div class="form-floating">
                                                            <label class="labeldata" hidden>Pengumuman Penyedia</label>
                                                            <input style="height: 30px; font-size: 13px;" value="-" type="text" name="pengumumanpenyedia" class="form-control" id="pengumumanpenyedia" hidden>
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-7">
                                                        <div class="form-floating">
                                                            <label hidden>Lap. Proses & Hasil Pengadaan</label>
                                                            <input style="height: 30px; font-size: 13px;" value="-" type="text" name="lapproseshasilpengadaan" class="form-control" id="lapproseshasilpengadaan" hidden>
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-7">
                                                        <div class="form-floating">
                                                            <label hidden>Nota Dinas</label>
                                                            <input style="height: 30px; font-size: 13px;" value="-" type="text" name="notadinas" class="form-control" id="notadinas" hidden>
                                                        </div>
                                                    </div>
                                                    <div class="col-5">
                                                        <div class="form-floating">
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-7">
                                                        <div class="form-floating">
                                                            <label hidden>SPPBJ</label>
                                                            <input style="height: 30px; font-size: 13px;" value="-" type="text" name="sppbj" class="form-control" id="sppbj" hidden>
                                                        </div>
                                                    </div>
                                                    <div class="col-5">
                                                        <div class="form-floating">
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-7">
                                                        <div class="form-floating">
                                                            <label hidden>Surat Pesanan</label>
                                                            <input style="height: 30px; font-size: 13px;" value="-" type="text" name="suratpesanan" class="form-control" id="suratpesanan" hidden>
                                ...
                                <!-- Footer -->
                                            <div class="modal-footer">  
                                                ...
                                                <a href=".php" type="button" class="btn btn-default">Batal</a>
