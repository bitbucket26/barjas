...
<head>
    ...
    <title>BA. Hasil Evaluasi Penawaran</title>
</head>
<style>
@media print {
  @page {
...
<body style="background-color: white; font-size: 17px; line-height: 20px; font-family: tahoma;">
<?php
...
<section class="sheet padding-10mm" style="font-size:17px;">
    <div class="container-xxl">
        ...
        <div class="d-flex justify-content-center">
            ...
            <br>
        <!-- Judul Nota -->
         <u><h4 class="text-center"><b>BERITA ACARA HASIL PENGADAAN LANGSUNG (BAHPL)</b></h4></u>
        <div class="row">
            <div class="col-4">
            </div>
            <div class="col-1">
        ...
        <div class="row">
            ...
            <div class="col-7">
            : Rp. <?php echo number_format($row['nilaihps']); ?> (<?php echo $row['terbilanghps']; ?>)						
            </div>
        </div>
