...
<body style="background-color: white; font-size: 17px; line-height: 23px; font-family: tahoma;">
<?php
...
<section class="sheet padding-10mm" style="font-size:17px;">
    <div class="container-xxl">
        ...
        <div class="d-flex justify-content-center">
            ...
            <br>
        <!-- Judul Nota -->
         <h4 class="text-center"><u><b>PENGUMUMAN PENYEDIA PENGADAAN BARANG/JASA</b></u></h4>
         <div class="row">
