...
<table class="table table-hover barang">
                                ...
                                <?php
                                $no=1;
                                 $data = mysqli_query($koneksi,"select * from barangekatalog where id='$_GET[id]'");
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo number_format($d['hargasatuanhps']) ?></td>
                                    <td class="text-center"><?php echo number_format($d['jumlahhps']) ?></td>
                                    <td class="text-center"><?php echo $d['volumenego'] ?></td>
                                    <td class="text-center"><?php echo number_format($d['hargasatuannego']) ?></td>
