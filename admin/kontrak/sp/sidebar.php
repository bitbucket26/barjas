<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../spk/spk.php">SPK (Nilai <= 200)</a>
                        <a class="collapse-item" href="sp.php">SP (Nilai > 200)</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="collapseOne2" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <!-- <h6 class="collapse-header">Kategori</h6> -->
                        <a class="collapse-item" href="../ekatalog/ekatalog.php">Dashboard E-Catalogue</a>
                        <!-- <a class="collapse-item" href="../ekatalog2/ekatalog.php">Nilai > 200 Jt</a> -->
                    </div>
                </div>
            </li>
                        <!-- Divider -->
            ...
            <hr class="sidebar-divider">
            <li class="nav-item">
                <a class="nav-link" href="../../pptk/pptk.php">
                    <!-- <i class="fas fa-fw fa-chart-area"></i> -->
