                                                ...
                                                <div class="row g-2">
                                                    <div class="col-4">
                                                        <div class="form-floating">
                                                            ...
                                                            <input style="height: 30px; font-size: 13px;" value="<?php echo $row['jeniskontrak']; ?>" type="text" name="jeniskontrak" value="SP" class="form-control" id="jeniskontrak" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                        <div class="form-floating">
                                                            <label class="labeldata">*</label>
                                                            <input style="height: 30px; font-size: 13px;" value="<?php echo $row['bilangjeniskontrak']; ?>" type="text" name="bilangjeniskontrak" value="Surat Perjanjian" class="form-control" id="bilangjeniskontrak" readonly>                                               
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row g-2">
                                        ...
                                        <div class="col-sm-6">
                                                ...
                                                <div class="row g-2">
                                                        ...
                                                        <div class="col-8">
                                                            <div class="form-floating">
                                                                <label class="labeldata">Terbilang</label>
                                                                <textarea style="font-size: 13px;" type="text" value="<?php echo $row['terbilangtotalhps']; ?>" name="terbilangtotalhps"  class="form-control" id="terbilangtotalhps" readonly><?php echo $row['terbilangtotalhps']; ?></textarea>                                            
                                                            </div>
                                                        </div>
                                                </div>
                                        </div>
                                                ...
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-floating">
                                                            ...
                                                            <input style="height: 30px; font-size: 13px;" type="text" value="<?php echo $row['nopenawaran']; ?>" name="nopenawaran" class="form-control" id="nopenawaran" required>
