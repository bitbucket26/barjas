                ...
                <div class="container-fluid" >
                    ...
                    ?>
                            <form method="post" class="form-user" style="font-size: 14px;">
                                ...
                                <div class="col-2" style="padding-top: 10px;">
                                                            <input style="height: 30px; font-size: 13px;" value="<?php echo $_SESSION['username']; ?>" type="text" name="user" class="form-control" id="user" hidden>                                                                                           
                                                        </div>
                                </div>
                                        <div class="row">
                    ...
                    <div class="card shadow mb-4" >
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Data Barang (SP E-Katalog)</h6>
                            </div>
