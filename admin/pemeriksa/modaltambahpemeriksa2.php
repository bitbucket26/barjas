...
<div class="modal fade" id="myModaltambahpemeriksa2" role="dialog">
                                    ...
                                    <form action="simpanpemeriksa2.php" method="POST">
                                    <?php
                                        include "../../koneksi.php";
                                        $sql = mysqli_query($koneksi, "select max(id) as maxID from pemeriksa2");
