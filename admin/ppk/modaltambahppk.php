...
<div class="modal fade" id="myModaltambahppk" role="dialog">
                                    ...
                                    <form action="simpanppk.php" method="POST">
                                    <?php
                                        include "../../koneksi.php";
                                        $sql = mysqli_query($koneksi, "select max(id) as maxID from ppk");
                                    ...
                                    ?>
                                                        ...
                                                        <div class="form-group">
                                                        <label>Nama</label>
                                                        <input type="text" name="namappk" class="form-control" required>      
                                                        </div> 
